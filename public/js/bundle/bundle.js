...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"axios/login.js":[function(require,module,exports) {
"use strict";
...
_defineProperty(Login, "login", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(correo, clave) {
    var res;
...
_defineProperty(Login, "logout", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
  var res;
...
_defineProperty(Login, "signup", /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(nombre, apellido, correo, clave, confirmarClave, grado, jornada) {
    var res;
...
},{"axios":"../../node_modules/axios/index.js"}],"pages/login.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.LoginDOM = void 0;

var _login = require("../axios/login");
...
var loginInputs = document.querySelectorAll(".formLogin__input");

var LoginDOM = function LoginDOM() {
  _classCallCheck(this, LoginDOM);
};

exports.LoginDOM = LoginDOM;

_defineProperty(LoginDOM, "animationInput", function () {
  if (loginInputs) {
...
_defineProperty(LoginDOM, "login", function () {
  if (loginForm) {
    loginForm.addEventListener("submit", function (e) {
      ...
      _login.Login.login(correo, clave);
    });
  }
});
},{"../axios/login":"axios/login.js"}],"pages/signup.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.SignupDOM = void 0;
...
var SignupDOM = function SignupDOM() {
  _classCallCheck(this, SignupDOM);
};

exports.SignupDOM = SignupDOM;

_defineProperty(SignupDOM, "signup", function () {
  if (signupForm) {
    signupForm.addEventListener("submit", function (e) {
      ...
      var correo = document.getElementById("email").value;
      var clave = document.getElementById("password").value;
      var confirmarClave = document.getElementById("passwordConfirm").value;
      var grado = document.getElementById("grade").value;
      var jornada = document.getElementById("jornada").value;

      _login.Login.signup(nombre, apellido, correo, clave, confirmarClave, grado, jornada);
    });
  }
});
},{"../axios/login":"axios/login.js"}],"utils/filterTopics.js":[function(require,module,exports) {
"use strict";
...
var Filter = /*#__PURE__*/function () {
  ...
  _createClass(Filter, null, [{
    key: "addOptions",
    value: function addOptions(domElement, data) {
    ...
    key: "removeOptions",
    value: function removeOptions(domElement) {
      _toConsumableArray(domElement.options).forEach(function (option) {
        return domElement.remove(option);
      });
    }
  }]);
...
},{}],"utils/data.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.subtemas = exports.temas = void 0;
var temas = {
  'Biología': [],
  'Química': [],
...
var subtemas = {
  ...
  'Álgebra': ['Ecuaciones Lineales', 'Ecuaciones Cuadráticas', 'Factorizar y Productos Notables', 'Fraccionarios', 'Números Reales', 'Inecuaciones', 'Exponentes y Radicales', 'Logaritmos', 'Números Complejos'],
  'Prefísica': ['Cinemática', 'Escalares y Vectores', 'Movimiento Circular', 'Trabajo y Energía', 'Momento Lineal y Colisiones', 'Torque y Momento Angular', 'Ondas y Oscilaciones', 'MAS', 'Circuitos', 'Dinámica'],
  'Precálculo': ['Polinomios', 'Trigonometría', 'Funciones', 'Matrices', 'Combinatoria', 'Probabilidad', 'Vectores', 'Cónicas', 'Álgebra', 'Números Complejos'],
  'Geometría Euclideana': ['Triángulos', 'Cuadrados', 'Polígonos Regulares', 'Círculos', 'Líneas Perpendiculares', 'Líneas Paralelas', 'Ángulos', 'Similaridad', 'Congruencias']
};
exports.subtemas = subtemas;
},{}],"utils/resize.js":[function(require,module,exports) {
"use strict";
...
},{"../utils/filterTopics":"utils/filterTopics.js","../utils/data":"utils/data.js","../utils/resize":"utils/resize.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _questionForm = require("./forms/questionForm");

// HomePage
_login.LoginDOM.login();

_login.LoginDOM.animationInput(); // Sign-up page


_signup.SignupDOM.signup(); // Question Form
